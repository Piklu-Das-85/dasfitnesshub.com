# CRAETE CLOUDFRONT DISTRIBUTION
...
resource "aws_cloudfront_distribution" "dfsc_distribution" {
    ...
    aliases = ["cdn.pikludascloud365.com"]
    ...
    viewer_certificate {
        ...
        acm_certificate_arn = "	arn:aws:acm:us-east-1:015148330366:certificate/17eacedc-d24c-4ad1-af0d-7eca4a46c301"
